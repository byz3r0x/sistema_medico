...
<form id="form1" name="form1" method="post" action="../Controlador/validarAsignarCita.php" role="form">
  <table width="43%" border="0" align="center">
    <tr class="texto">
      <td colspan="2" align="center">ASIGNAR CITA</td>
    </tr>
    <tr>
      <td width="33%" align="right"  class="col-lg-2 control-label">Paciente:</td>
      <td width="67%"><select name="paciente" id="paciente" style="width:300px"class="form-control">
        <option value="0" class="form-control">Seleccione</option>
        <?php
    ...
    <tr>
     <td width="33%" align="right" class="col-lg-2 control-label">Fecha:</td>
      <td><label for="fecha"></label>
      <input type="date" name="fecha" id="fecha" required="required" style="width:290px" class="form-control" /></td>
    </tr>
    <tr>
      <td width="33%" align="right"  class="col-lg-2 control-label">Hora:</td>
      <td><input type="time" name="hora" id="hora" required="required" class="form-control"/></td>
    </tr>
    <tr>
     <td width="33%" align="right" class="col-lg-2 control-label">Medico:</td>
    ...
    <tr>
      <td width="33%" align="right"  class="col-lg-2 control-label">Consultorio</td>
      <td><select name="consultorio" id="consultorio" class="form-control">
        <option value="0">Seleccione</option>
        <?php
